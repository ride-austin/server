...
import com.rideaustin.test.setup.RA137WODCDriverSetup;
...
@WebAppConfiguration
public class RA137WODCDriverIT extends AbstractNonTxTests<RA137WODCDriverSetup> {
  ...
  @Test
  public void testSearchWODoesntFindDC() throws Exception {
    ...
    final List<CompactActiveDriverDto> result = riderAction.searchDrivers(rider.getEmail(), location, TestUtils.REGULAR, DriverType.WOMEN_ONLY);
