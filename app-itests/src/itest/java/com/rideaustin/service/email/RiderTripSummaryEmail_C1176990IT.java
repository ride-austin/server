...
public class RiderTripSummaryEmail_C1176990IT extends AbstractTripSummaryEmailNonTxTest<C1176987Setup> {

  @Test
  @TestCases("C1176990")
  public void shouldSendTripSummaryEmail_WithRoundUp() throws Exception {
    ...
    EmailAssert.assertThat(recentMessages).tripSummaryEmailDeliveredWithRoundUp(startDate, rider.getEmail());
  }
}
