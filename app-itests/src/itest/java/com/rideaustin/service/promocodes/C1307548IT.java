...
@WebAppConfiguration
public class C1307548IT extends BaseC1307548_53Test<C1307548Setup> {
  ...
  public void test() throws Exception {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      assertEquals(rideInfo.getSubTotal().getAmount().doubleValue(), rideInfo.getFreeCreditCharged().getAmount().doubleValue(), 0.0);
    }
