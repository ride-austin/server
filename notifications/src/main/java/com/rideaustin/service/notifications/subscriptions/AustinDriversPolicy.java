...
@Component
public class AustinDriversPolicy implements SubscriptionPolicy {

  @Override
  public boolean shouldSubscribe(Token token) {
    return token.getAvatarType().equals(AvatarType.DRIVER) && token.getAgent().equals(ClientAgentCity.AUSTIN);
  }
}
