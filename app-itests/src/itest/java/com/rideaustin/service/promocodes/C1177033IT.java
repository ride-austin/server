...
public class C1177033IT extends AbstractNonTxPromocodeTest<C1177039Setup> {
  ...
  @Test
  @TestCases("C1177033")
  public void shouldApplyPromocode_WhenTripFareIsEqualToFreeCredit() throws Exception {
    ...
    assertThat(ride.getFareTotal().getAmount()).isEqualByComparingTo(setup.getRedemption().getOriginalValue());
  }
