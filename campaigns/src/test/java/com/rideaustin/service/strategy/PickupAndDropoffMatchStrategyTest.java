...
public class PickupAndDropoffMatchStrategyTest {
  ...
  private PickupAndDropoffMatchStrategy testedInstance;

  @Before
  public void setUp() throws Exception {
    MockitoAnnotations.initMocks(this);

    testedInstance = new PickupAndDropoffMatchStrategy(pickupMatchStrategy, dropoffMatchStrategy);
  }
