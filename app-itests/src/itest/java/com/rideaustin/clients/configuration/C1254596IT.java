...
/**
 * @see <a href="http://testrail.devfactory.com/index.php?/cases/view/C1254596">C1254596</a>
 */
...
@WebAppConfiguration
public class C1254596IT extends AbstractTransactionalJUnit4SpringContextTests {
  ...
  private String itemKey = C1254596IT.class.getSimpleName();
  ...
  @Test
  @TestCases("C1254596")
  public void update_existing_driver_configuration_item_when_driver_is_ONLINE() throws Exception {
    ...
    configurationItemsDriverAction.getAsyncDispatch(mvcResult)
      ...
      .andExpect(jsonPath("$[1].eventType").value(equalTo(EventType.CONFIG_CHANGED.name())))
      .andExpect(jsonPath("$[1].parameters").value(notNullValue()))
    ;
