...
/**
 * https://testrail.devfactory.com/index.php?/cases/view/1182995
 */
@Category(Redispatch.class)
public class C1182995IT extends AbstractRedispatchTest<DefaultRedispatchTestSetup> {
  ...
  protected void acceptRedispatched(ActiveDriver driver, Long ride) throws Exception {
    ...
    awaitState(ride, States.DRIVER_REACHED);
