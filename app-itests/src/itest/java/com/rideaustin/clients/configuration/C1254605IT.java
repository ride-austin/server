...
/**
 * @see <a href="http://testrail.devfactory.com/index.php?/cases/view/C1254605">C1254605</a>
 */
...
@WebAppConfiguration
public class C1254605IT extends AbstractTransactionalJUnit4SpringContextTests {
  ...
  private String itemKey = C1254605IT.class.getSimpleName();
  ...
  @Test
  @TestCases("C1254605")
  public void update_existing_driver_configuration_No_Changes() throws Exception {
    ...
    configurationItemsAdminAction.update(administrator.getEmail(), itemId, "{\"configurationValue\" : {\"some\" : \"json\"}}")
      .andDo(print())
      .andExpect(status().isOk());
